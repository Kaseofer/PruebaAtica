...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container mt-4">
     ...
     <div class="table-responsive">
        <asp:GridView ID="gvUsuarios" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped" OnRowCommand="gvUsuarios_RowCommand">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Acciones">
                    <ItemTemplate>
                        <asp:Button ID="btnEliminar" runat="server" Text="Eliminar"
                           ...
                           OnClientClick  ='<%# "confirmarBorrado(\"" + Eval("Nombre") + "\", \"" + Eval("Id") + "\"); return false" %>' />                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnConfirmarEliminar" runat="server" Text="🗑️ Eliminar usuario" CssClass="btn btn-danger" OnClick="btnConfirmarEliminar_Click" />
